...
La funzione readMatrix, dato il path di un file, legge la dimensione della matrice in esso, aggiorna la variabile n nel main, restituisce una matrice allocata.
