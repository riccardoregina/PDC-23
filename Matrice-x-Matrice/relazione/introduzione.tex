...
Dividiamo le matrici in blocchi quadrati: verranno creati delle sottomatrici $A_{ij}$, $B_{ij}$, $C_{ij}$, che verranno assegnate ai processi in posizione $ij$ nella griglia.
